...
/*$("#device-search1").click(function(){
		...
		var value = $("#device-search").val();	
		 $.post("${contextPath}/controller/secondSearch", 
			...
			{
				window.location.href="${contextPath1}singleDeviceFirst.jsp?imei="+value; 	
			}
	...
	$("#editNicknameModal .saveBtn").click(function(){
		var userName1= $('#userName1').val();
 		 $.post("${contextPath}/controller/updatePersonalAdminAccount", {
 			adminName: userName1,	
		}, function(data){
	...
	$("#editPasswordModal .saveBtn").click(function(){
		...
		if(password1=="")
          ...
          if(password2==password3)
        	  {
       $.post("${contextPath}/controller/updatePersonalAdminAccount1", {
