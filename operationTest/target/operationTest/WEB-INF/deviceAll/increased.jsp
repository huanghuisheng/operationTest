										...
										<div class="data-box-content">
											<ul class="userinfo-data">
												<li class="usda-row">
													...
													<div class="usda-cell head">昨日新增用户</div>
													<div class="usda-cell head">过去7天新增用户</div>
													<div class="usda-cell head">过去30天新增用户</div>
												</li>
												<li class="usda-row">
													<div class="usda-cell">
														<p id="data1">123</p>
										...
										<div class="data-box-content">
											<div>
												<div class="area-left">
													...
													<div id="container" class="acontainer"></div>

												</div>


												<div class="area-right1">
													<div id="container1" class="acontainer1"></div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$.getJSON("${contextPath}/controller/newlyincreasedUser", function(data) {
			$("#data1").html("");//清空info内容
			$("#data1").html(data[0].new_0);
			$("#data2").html("");//清空info内容
			$("#data2").html(data[0].new_1);
			$("#data3").html("");//清空info内容
			$("#data3").html(data[0].new7);
			$("#data4").html("");//清空info内容
			$("#data4").html(data[0].new30);
		});
		//----------------------------------------------------------------------------------图表
		$
				.getJSON("${contextPath}/controller/newlyincreasedTendency",
						function(data) {
							...
							option2 = {
								...
								series : [ {
									...
									type : 'line',
									stack : '总量',
									data : [ data[0].new_6, data[0].new_5,
											data[0].new_4, data[0].new_3,
											data[0].new_2, data[0].new_1,
											data[0].new_0 ]
								} ]
							};
							;
		...
		$.post("${contextPath}/controller/newlyAreaDistribution", {
			starttime : "00.00.00",
			endtime : strs2[1],
		}, function(data) {
			...
			option1 = {
				...
				/*data[9].city, data[10].city, data[11].city, 
				data[12].city, data[13].city, data[14].city, 
				data[15].city, data[16].city, data[17].city, 
				data[18].city, data[19].city, data[20].city, 
				data[21].city, data[22].city, data[23].city, 
				data[24].city, data[25].city, data[26].city, 
				data[27].city, data[28].city, data[29].city, 
				data[30].city, data[31].city,data[32].city,
				data[33].city,] */
				},
				series : [ {
					/* name : '新增用户', */
	...
	$(".tendency_model").bind('click', function() {
	   ...
	   $("#dynamic-dialog").addClass("dialog");
		...
		//发送请求；
		$.post("${contextPath}/controller/newlyincreasedTendency1", {
			starttime : strs[0],
			endtime : strs[1],
			regoin : area,
			model : model
